          ...
          <div class="participants-section">
            ...
            ${details.participants.length > 0 ? `
              <ul class="participants-list">
                ${details.participants.map(email => `<li data-email="${email}" data-activity="${name}"><span>${email}</span><button type="button" class="delete-participant" title="Remove">✕</button></li>`).join('')}
              </ul>
